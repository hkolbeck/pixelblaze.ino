...
WebsocketFormat websocketFormatFromInt(int v) {
    switch (v) {
        case 1:
...
ChannelType channelTypeFromInt(int v) {
    switch (v) {
        case 1:
...
RenderType renderTypeFromInt(int v) {
    switch (v) {
        case 0:
...
InputSource inputSourceFromInt(int v) {
    switch (v) {
        case 0:
...
FramePosition framePositionFromInt(int v) {
    switch (v) {
        case 1:
...
SequencerMode sequencerModeFromInt(int v) {
    switch (v) {
        case 0:
